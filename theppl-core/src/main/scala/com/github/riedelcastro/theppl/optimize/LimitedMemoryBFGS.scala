...
import com.github.riedelcastro.theppl.util.{Util, HasLogger, ArrayImports}
import Util._
...
class LimitedMemoryBFGS(val optimizable: OptimizableByValueAndGradient) extends Optimizer with HasLogger {
