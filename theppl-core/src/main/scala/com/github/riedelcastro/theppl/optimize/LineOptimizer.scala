...
import com.github.riedelcastro.theppl.util.{ArrayImports, Util, HasLogger}
import Util._
...
@author Andrew McCallum
 */
class BackTrackLineOptimizer(val optimizable: OptimizableByValueAndGradient, val maxIterations: Int = 100) extends LineOptimizer with HasLogger {
